 ...
 * @access public
 */
const baseUrl = 'https://www.qianrong.net'
function Strategy(options, verify) {
  options = options || {};
  options.authorizationURL = options.authorizationURL || `${baseUrl}/user/thirdlogin`;
  ...
  this.name = 'plogin';
  this._userProfileURL = options.userProfileURL || `${baseUrl}/oauth/user`;
